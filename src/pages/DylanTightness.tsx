...
type ActivityId = 'elden' | 'apex' | 'online'
...
function DylanTightness() {
  ...
  const trackers = useMemo<LiveTracker[]>(
    () =>
      (['elden', 'apex', 'online'] as ActivityId[]).map((id) => ({
        id,
        ...activityCopy[id],
        ...
        <div className="dylan-chart-wrap">
          <svg className="dylan-chart" viewBox="0 0 1000 320" role="img" aria-label="Dylan tightness graph over the last 24 hours">
            ...
            <g className="dylan-chart-zones">
              <rect className="dylan-zone dylan-zone--elden" x="0" y="25" width="1000" height="58.75" />
              <rect className="dylan-zone dylan-zone--apex" x="0" y="83.75" width="1000" height="58.75" />
              <rect className="dylan-zone dylan-zone--online" x="0" y="142.5" width="1000" height="58.75" />
              <rect className="dylan-zone dylan-zone--loose" x="0" y="201.25" width="1000" height="58.75" />
            </g>
